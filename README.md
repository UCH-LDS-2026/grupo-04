...
- **Gestión de catálogo:** Registro de productos con precios y existencias.
- **Control de stock en tiempo real:** Actualización automática de unidades tras cada venta.
- **Punto de Venta (API):** Endpoints REST para procesar transacciones y registrar ventas.
- **Alertas de stock crítico:** Notificaciones automáticas cuando un producto alcanza un nivel mínimo (5 unidades por defecto).

## Stack tecnológico
- **Backend:** PHP (8.x) con arquitectura POO y procedural.
...
Paso 4: Testear los Endpoints de la API
Obtener productos: GET http://localhost:8000/src/productos.php

Alertas de stock crítico: GET http://localhost:8000/src/productos.php?alertas=1
